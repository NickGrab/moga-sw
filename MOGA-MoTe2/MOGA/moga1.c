...
void processor_run(int iter_num, char folder[], char inputs[]) {
    ...
    double A[6], rho[6], B[6], lambda[5], gamma_MoTe1Te2[2], gamma_3b[2], gamma_rest[4]; //variables modified in the force field file
    ...
    sscanf(inputs,"%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", 
	  &A[0],&A[1],&A[2],&A[3],&A[4],&A[5],&rho[0],&rho[1],&rho[2],&rho[3],&rho[4],&rho[5],&B[0],&B[1],&B[2],&B[3],&B[4],&B[5],
          &lambda[0],&lambda[1],&lambda[2],&lambda[3],&lambda[4],&gamma_MoTe1Te2[0],&gamma_MoTe1Te2[1], &gamma_rest[0], &gamma_rest[1], gamma_rest[2], gamma_rest[3]);
...
int main(int argc, char *argv[]) {
    ...
    int iteration_num = 1000; // number of training iterations
